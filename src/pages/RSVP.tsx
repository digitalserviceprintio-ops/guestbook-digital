    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-5">
        <motion.div
          ...
          className="max-w-sm w-full rounded-2xl bg-card p-8 shadow-elevated text-center space-y-4"
        >
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-md mx-auto px-5 py-10 space-y-6">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-center space-y-2">
          ...
          <h1 className="font-display text-2xl font-bold text-foreground">RSVP</h1>
          <p className="text-sm font-body text-muted-foreground">
        ...
        >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 rounded-xl py-3 text-sm font-body font-medium transition-all ${
                  status === "hadir" ? "gradient-gold text-primary-foreground shadow-card" : "bg-card text-muted-foreground"
                }`}
              >
                Ya, Saya Hadir
              </button>
              <button
                ...
                className={`flex-1 rounded-xl py-3 text-sm font-body font-medium transition-all ${
                  status === "tidak_hadir" ? "bg-destructive text-destructive-foreground shadow-card" : "bg-card text-muted-foreground"
                }`}
              >
                Tidak Hadir
              </button>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Tuliskan ucapan untuk pengantin..."
              rows={3}
              maxLength={500}
